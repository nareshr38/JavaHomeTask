...
import com.ranguht.code.javabasics.hometask5.InOrder;
...
public class InorderTest {
    ...
    InOrder inOrderObj=new InOrder();

    @Test
    public void test1() {
        boolean expectedResult = true;
        boolean actualResult = inOrderObj.Order(1, 2, 4, false);
    ...
    public void test2() {
        ...
        boolean actualResult = inOrderObj.Order(1, 2, 1, false);
        Assert.assertEquals(expectedResult, actualResult);
